...
export default function HeroSection() {
  return (
    <section className="relative flex flex-col gap-7 h-screen text-center pt-52 xl:pt-72">
      <Image
        src={"/herosection-bg.png"}
        className="absolute top-0 h-full w-full object-cover object-[65%_75%] -z-20"
        width={2000}
        height={2000}
